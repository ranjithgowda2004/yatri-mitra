 YatriMitraSharedMobilityApp – Android App
...
ui/ → Screens, navigation, and UI components data/ → Database, DAO, and repositories domain/ → Models and business logic di/ → Dependency injection modules viewmodel/ → ViewModels for state management
...
Click Run
🎯 Purpose
This app is designed to simplify local transportation. You can book rides, track trips, access emergency services, and manage travel data in one place without relying fully on internet connectivity.

🔮 Future Improvements
• Real time GPS tracking integration • Online payments and wallet system • Driver and rider rating system • Ride scheduling and automation • Multi city and regional expansion

🤝 Contributing
Fork the repository Create a new branch Make changes and commit Push changes Create a pull request

👨‍💻 Author
Developed by RANJITH L
